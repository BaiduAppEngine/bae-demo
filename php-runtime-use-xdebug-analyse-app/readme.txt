...
6、php.ini中打开了xdebug的相关配置，为什么这么神奇？请参看 [bae3.0 php runtime 如何自定义php.ini http://godbae.duapp.com/?p=299]；
7、注意：分析过程极其消耗性能，如果您分析完成，删掉对应的文件重新发布即可，特别是此demo中的php.ini，删掉即可关闭xdebug。
8、最重要的，如何使用！ 
